...
class PhysicsInformedNN:
    ...
    def train(self, nIter, save_checkpoint=False): 
        ...
        for it in range(nIter):
            ...
            if it % 5000 == 0 and save_checkpoint:
                self.checkpoint(it)
    ...
    def checkpoint(self, epoch):
        ...
        np.save("saved/p_pred_nn_%s_%dk.npy" % (args.mod, int(epoch/1000)), p_pred)
...
if __name__ == "__main__": 
    ...
    np.save("saved/p_pred_nn_%s_final.npy" % args.mod, p_pred)
...
#    plot_solution(X_star, p_star - p_pred, 5)
    ...
    np.save('loss/loss_clean_PINNs.npy', loss_log)
    ...
    loss_log = np.array(model.loss_log)
    np.save('loss/loss_noisy_PINNs.npy', loss_log)         
